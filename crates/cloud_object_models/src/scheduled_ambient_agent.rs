...
pub struct AgentConfigSnapshot {
    ...
    /// BYOP endpoint URL forwarded to a remote worker for child agent LLM calls.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub byop_base_url: Option<String>,
    /// BYOP API wire protocol name forwarded alongside `byop_base_url`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub byop_api_type: Option<String>,
    /// BYOP provider ID used for remote conversation compaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub compaction_model_provider_id: Option<String>,
    /// BYOP model ID used for remote conversation compaction.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct HarnessAuthSecretsConfig {
    ...
    /// Name of a managed secret containing BYOP provider credentials.
    #[serde(default, skip_serializing_if = "Option::is_none")]
